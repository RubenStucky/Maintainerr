  ...
  applications: ApplicationProperties[] = [
    ...
    },
    {
      ...
      props: [
        ...
        {
          id: 32,
          name: 'sw_nextSeasonExists',
          humanName: 'Next season exists (TMDb)',
          mediaType: MediaType.SHOW,
          type: RuleType.BOOL,
          showType: ['season'],
        },
    ...
    },
    {
      ...
      props: [
        ...
        {
          id: 7,
          name: 'sw_nextSeasonRequested',
          humanName: 'Next season already requested in Seerr',
          mediaType: MediaType.SHOW,
          type: RuleType.BOOL,
          showType: ['season'],
        },
        {
          id: 8,
          name: 'sw_nextSeasonDeletedInSeerr',
          humanName: 'Next season deleted in Seerr (was previously available)',
          mediaType: MediaType.SHOW,
          type: RuleType.BOOL,
          showType: ['season'],
        },
